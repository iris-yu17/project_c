...
import Monster from './Images/Monster-green.svg';
import TopArrow from './Images/TopArrow-green.svg';

function ScrollButtonGreen(props) {
...
export default ScrollButtonGreen;