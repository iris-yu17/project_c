...
function ClaudiaIndexMap(props) {
  ...
  const showIcon = (e) => {
    ...
    if (selectedCityItem !== undefined) {
      // console.log('selectedCityItem', selectedCityItem)
  ...
  return (
    <>
      <div className="claudia-index-map-inside">
        <svg
          fill="#EDE885"
        ...
        >
          ...
          <path
            ...
            data-item="claudia-new-taipei-city"
            data-id="2"
            onMouseEnter={showIcon}
            onClick={showCardList}
            className="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
        ...
        {/* taipei */}
        <img
          className="claudia-icon claudia-taipei"
          id="claudia-taipei1"
          alt=""
          src={Icon}
        />
        {/* new taipei city */}
        <img
          className="claudia-icon claudia-new-taipei-city"
          id="claudia-new-taipei1"
          alt=""
          src={Icon}
        />
        <img
          className="claudia-icon claudia-new-taipei-city"
          id="claudia-new-taipei2"
          alt=""
          src={Icon}
        />
        <img
          className="claudia-icon claudia-new-taipei-city"
          id="claudia-new-taipei3"
          alt=""
          src={Icon}
        />
        <img
          className="claudia-icon claudia-new-taipei-city"
          id="claudia-new-taipei4"
          alt=""
          src={Icon}
        />
        {/* keelung */}
        <img
          className="claudia-icon claudia-keelung"
          id="claudia-keelung1"
          alt=""
          src={Icon}
        />
        {/* yilan */}
        <img
          className="claudia-icon claudia-yilan"
          id="claudia-yilan1"
          alt=""
          src={Icon}
        />
        ...
        {/* hualien */}
        <img
          className="claudia-icon claudia-hualien"
          id="claudia-hualien1"
          alt=""
          src={Icon}
        />
        ...
        {/* taitung */}
        <img
          className="claudia-icon claudia-taitung"
          id="claudia-taitung1"
          alt=""
          src={Icon}
        />
        ...
        {/* taoyuan */}
        <img
          className="claudia-icon claudia-taoyuan"
          id="claudia-taoyuan1"
          alt=""
          src={Icon}
        />
        ...
        {/* hsinchu */}
        <img
          className="claudia-icon claudia-hsinchu"
          id="claudia-hsinchu1"
          alt=""
          src={Icon}
        />
        {/* miaoli */}
        <img
          className="claudia-icon claudia-miaoli"
          id="claudia-miaoli1"
          alt=""
          src={Icon}
        />
        {/* taichung */}
        <img
          className="claudia-icon claudia-taichung"
          id="claudia-taichung1"
          alt=""
          src={Icon}
        />
        <img
          className="claudia-icon claudia-taichung"
          id="claudia-taichung2"
          alt=""
          src={Icon}
        />
        {/* changhua */}
        <img
          className="claudia-icon claudia-changhua"
          id="claudia-changhua1"
          alt=""
          src={Icon}
        />
        <img
          className="claudia-icon claudia-changhua"
          id="claudia-changhua2"
          alt=""
          src={Icon}
        />
        {/* yunlin */}
        <img
          className="claudia-icon claudia-yunlin"
          id="claudia-yunlin1"
          alt=""
          src={Icon}
        />
        ...
        {/* chiayi */}
        <img
          className="claudia-icon claudia-chiayi"
          id="claudia-chiayi1"
          alt=""
          src={Icon}
        />
        ...
        {/* tainan */}
        <img
          className="claudia-icon claudia-tainan"
          id="claudia-tainan1"
          alt=""
          src={Icon}
        />
        {/* nantou */}
        <img
          className="claudia-icon claudia-nantou"
          id="claudia-nantou1"
          alt=""
          src={Icon}
        />
        {/* kaohsiung */}
        <img
          className="claudia-icon claudia-kaohsiung"
          id="claudia-kaohsiung1"
          alt=""
          src={Icon}
        />
        <img
          className="claudia-icon claudia-kaohsiung"
          id="claudia-kaohsiung2"
          alt=""
          src={Icon}
        />
        {/* pingtung */}
        <img
          className="claudia-icon claudia-pingtung"
          id="claudia-pingtung1"
          alt=""
          src={Icon}
        />
      </div>
