...
router.post('/my-order-detail', async (req, res)=>{
    // console.log(req.body)
     ...
     const sql = "INSERT INTO `my_order_detail` (product_sid,product_amount, product_name,product_price) VALUE ?";

     const rebuild =req.body.map((item)=>[item.product_sid,item.product_amountitem.product_name,item.product_price ])
